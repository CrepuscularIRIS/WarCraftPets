...
@register_handler(62)
class H_Prop62_DmgIsPeriodic:
    """Damage with explicit periodic flag.

    DB2 ParamLabel: Points,Accuracy,IsPeriodic,,,

    Notes:
      - When IsPeriodic=1, racials (e.g., Aquatic passive) may modify the result.
    """
