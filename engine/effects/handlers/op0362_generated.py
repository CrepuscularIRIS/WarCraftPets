...
@register_handler(362)
class H_Prop362_Unknown:
    PROP_ID = 362

    def apply(self, ctx, actor, target, effect_row, args) -> EffectResult:
        """
        Unknown effect (opcode 362)
        Used by ability_id: [2260]
        ...
        # 记录unknown effect
        ctx.log.effect_result(effect_row, actor, target, code="UNKNOWN", reason="opcode_362")
        
        return EffectResult(executed=True, notes={"opcode": 362, "type": "unknown"})
