...
@register_handler(65)
class H_Prop65_Unknown:
    PROP_ID = 65

    def apply(self, ctx, actor, target, effect_row, args) -> EffectResult:
        """
        Unknown effect (opcode 65)
        Used by ability_id: [742]
        ...
        # 记录unknown effect
        ctx.log.effect_result(effect_row, actor, target, code="UNKNOWN", reason="opcode_65")
        
        return EffectResult(executed=True, notes={"opcode": 65, "type": "unknown"})
