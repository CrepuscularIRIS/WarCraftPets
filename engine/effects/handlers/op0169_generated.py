...
@register_handler(169)
class H_Prop169_Unknown:
    PROP_ID = 169

    def apply(self, ctx, actor, target, effect_row, args) -> EffectResult:
        """
        Unknown effect (opcode 169)
        Used by ability_id: [171]
        ...
        # 记录unknown effect
        ctx.log.effect_result(effect_row, actor, target, code="UNKNOWN", reason="opcode_169")
        
        return EffectResult(executed=True, notes={"opcode": 169, "type": "unknown"})
