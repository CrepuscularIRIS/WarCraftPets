...
@register_handler(45)
class H_Prop45_Unknown:
    PROP_ID = 45

    def apply(self, ctx, actor, target, effect_row, args) -> EffectResult:
        """
        Unknown effect (opcode 45)
        Used by ability_id: [2024]
        ...
        # 记录unknown effect
        ctx.log.effect_result(effect_row, actor, target, code="UNKNOWN", reason="opcode_45")
        
        return EffectResult(executed=True, notes={"opcode": 45, "type": "unknown"})
