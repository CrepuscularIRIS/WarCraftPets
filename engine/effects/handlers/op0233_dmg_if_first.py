...
@register_handler(233)
class H_Prop233_DmgIfFirst:
    """Damage that only applies if the user attacks first this round.

    DB2 ParamLabel: Points,Accuracy,,,,

    Typical use:
      - Tail Sweep (deals lower damage unless the user strikes last -> paired with Prop234).
